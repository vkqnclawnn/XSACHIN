document.addEventListener('DOMContentLoaded', () => {
    ...
    // Updated questions array with 10 questions, scores inverted (high score = cool)
    const questions = [
        { // 1. 가장 일반적인 소통
    ...
    function getResultSummary(score) {
        // 총 10문제, 문제당 최대 10점, 총점 100점 기준 (높을수록 쿨함)
        if (score >= 80) return `1단계: 완전 쿨내 진동! 내 사람 믿어주는 당신의 연인
"어? 남사친이랑 논다고? 응, 재미있게 놀다 와! 나도 내 할 일 할게!"

당신은 정말이지 대인배 스타일이네요. 남사친, 여사친 존재를 당연하게 받아들이고,어떤 친구를 만나든 전적으로 믿어줘요. 어쩌면 관계에 대한 확신이 엄청나거나, 각자의 사생활을 존중하는 게 중요하다고 생각하는 사람일 거예요. 당신같은 이런 연인이라면 마음 편하게 친구들을 만날 수 있겠죠?`; // 80-100점 (가장 쿨함)
        if (score >= 60) return `2단계: 어라? 갑자기 촉이 오네? 살짝은 신경 쓰이는 당신의 연인
"오늘 누구 만났어? 아, 그 친구? 잘 놀았어? 히히."

대놓고 질투하는 건 아닌데, 남사친이나 여사친을 만났다고 하면 괜히 한 번 더 물어보는 스타일이에요.혹시나 하는 마음에 살짝 궁금해하는 정도랄까요? 귀여운 질투라고 할 수 있죠! 당신이 애인을 너무 좋아해서 생기는 자연스러운 반응이니, 예쁘게 봐주세요!`; // 60-79점
...
이 단계부터는 연인의 질투가 꽤나 직접적으로 드러나요. 연인의 X사친과의 관계에 대해 노골적으로 불만을 표현하거나, 연인에게 조심하라고 이야기할 수도 있어요. 연인을 너무 사랑해서 다른 이성과 관계를 못마땅하게 보는 건데, 이때는 서로 마음을 좀 헤아려 줄 필요가 있어요 친구 관계도 중요하지만, 연인의 마음도 소중하니까요!`; // 20-39점
        return `5단계: 내 옆엔 오직 나뿐! 레전드 질투심을 보이는 당신
"도대체 그 친구가 왜 자꾸 너한테 연락하는 거야? 나랑 만나면서 굳이 그 친구랑 볼 필요 있어? 앞으로 그 친구 만나지 마."

아마도 당신은 연인을 향한 독점욕이 엄청나게 강할 거예요. X사친과의 모든 교류를 극도로 싫어하고, 친구 관계에 대놓고 개입하려 할 수 있어요. 심지어 연락 자체를 못하게 하거나, 특정 친구를 만나지 말라고 요구할 수도 있죠. 연인을 너무 사랑해서 그런 거겠지만, 이런 경우에는 연인과 솔직하고 진지하게 대화해서 서로의 선을 정하는 게 정말 중요해요.`; // 0-19점 (가장 질투심 강함)
    }
